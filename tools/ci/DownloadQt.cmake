...
# It is kept for local manual Qt downloads but may need updates for future Qt versions.
# Prefer using the Qt online installer or `aqtinstall` for local builds.

string(REGEX MATCH "^[0-9]+" qt_version_major "${qt_version}")
string(REPLACE "." "" qt_version_dotless "${qt_version}")
if ("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Windows")
  set(url_os "windows_x86")
  # Qt 6.8+ uses MSVC2022
...
elseif ("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Linux")
  ...
  elseif (qt_version VERSION_GREATER_EQUAL "6.8")
    set(qt_package_suffix "-Linux-RHEL_9_2-GCC-Linux-RHEL_9_2-X86_64")
  else()
...
elseif ("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Darwin")
  ...
  elseif (qt_version VERSION_GREATER_EQUAL "6.8")
    # Qt 6.8+ uses macos universal with darwin 14+
    set(qt_package_arch_suffix "clang_64")
